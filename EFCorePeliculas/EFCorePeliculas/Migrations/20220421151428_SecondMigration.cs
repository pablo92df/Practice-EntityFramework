    ...
    public partial class SecondMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                table: "Actors",
                columns: new[] { "Id", "Biografia", "FechaNacimiento", "Name" },
                values: new object[,]
                {
            ...
            migrationBuilder.InsertData(
                table: "Peliculas",
                columns: new[] { "Id", "EnCartelera", "FechaEstreno", "Name", "PosterURL" },
                values: new object[,]
                {
                    ...
                    { 5, true, new DateTime(2022, 4, 21, 0, 0, 0, 0, DateTimeKind.Local), "The Matrix Resurrections", "https://upload.wikimedia.org/wikipedia/en/5/50/The_Matrix_Resurrections.jpg" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2022, 4, 28, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 4, 21, 0, 0, 0, 0, DateTimeKind.Local), 10m },
                    { 2, 4, new DateTime(2022, 4, 26, 0, 0, 0, 0, DateTimeKind.Local), new DateTime(2022, 4, 21, 0, 0, 0, 0, DateTimeKind.Local), 15m }
                });
