...
namespace EFCorePeliculas.Migrations
{
    ...
    [Migration("20220429172543_HerenciaPorTipo")]
    partial class HerenciaPorTipo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFCorePeliculas.Entities.CineDetalle", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCorePeliculas.Entities.CineOferta", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 2,
                            CineId = 4,
                            FechaFin = new DateTime(2022, 5, 4, 0, 0, 0, 0, DateTimeKind.Local),
                            FechaInicio = new DateTime(2022, 4, 29, 0, 0, 0, 0, DateTimeKind.Local),
                        ...
                        new
                        {
                            Id = 1,
                            CineId = 1,
                            FechaFin = new DateTime(2022, 5, 6, 0, 0, 0, 0, DateTimeKind.Local),
                            FechaInicio = new DateTime(2022, 4, 29, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("EFCorePeliculas.Entities.Mensaje", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCorePeliculas.Entities.Pago", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCorePeliculas.Entities.Pelicula", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = 5,
                            EnCartelera = true,
                            FechaEstreno = new DateTime(2022, 4, 29, 0, 0, 0, 0, DateTimeKind.Local),
            ...
            modelBuilder.Entity("EFCorePeliculas.Entities.Persona", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCorePeliculas.Entities.SinLlaves.CineSinUbicacion", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCorePeliculas.Entities.SinLlaves.PeliculaConConteos", b =>
                {
            ...
            modelBuilder.Entity("EFCorePeliculas.Entities.PagoTarjeta", b =>
                {
                    b.HasBaseType("EFCorePeliculas.Entities.Pago");

                    b.Property<string>("Ultimos4Difitos")
                        .IsRequired()
            ...
            modelBuilder.Entity("EFCorePeliculas.Entities.Actor", b =>
                {
                    b.OwnsOne("EFCorePeliculas.Entities.Direccion", "BillingAddress", b1 =>
                        {
                    ...
                    b.OwnsOne("EFCorePeliculas.Entities.Direccion", "DireccionHogar", b1 =>
                        {
                            b1.Property<int>("ActorId")
                                .HasColumnType("int");
            ...
            modelBuilder.Entity("EFCorePeliculas.Entities.Cine", b =>
                {
                    b.OwnsOne("EFCorePeliculas.Entities.Direccion", "Direccion", b1 =>
                        {
            ...
            modelBuilder.Entity("EFCorePeliculas.Entities.CineDetalle", b =>
                {
                    b.HasOne("EFCorePeliculas.Entities.Cine", "Cine")
                        .WithOne("CineDetalle")
                        .HasForeignKey("EFCorePeliculas.Entities.CineDetalle", "Id")
            ...
            modelBuilder.Entity("EFCorePeliculas.Entities.Mensaje", b =>
                {
                    b.HasOne("EFCorePeliculas.Entities.Persona", "Emisor")
                        .WithMany("MensajesEnviados")
                        .HasForeignKey("EmisorID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("EFCorePeliculas.Entities.Persona", "Receptor")
