    ...
    public class AutoMapperProfiles : Profile
    {
        public AutoMapperProfiles()
        {
           ...
           // sin projectTo
            ...
            //    .ForMember(dto => dto.Cines, ent => ent.MapFrom(prop =>
            //             prop.SalaDeCines.Select(s => s.Cine)))
            //    .ForMember(dto => dto.Actores, ent =>
            //             ent.MapFrom(prop => prop.PeliculasActores.Select(pa => pa.Actor)));
            ...
            CreateMap<CineCreacionDTO, Cine>()
                ...
                dto => dto.MapFrom(campo => geometryFactory
                .CreatePoint(new Coordinate(campo.Longitud, campo.Latitud))));
